...
export const NAV_GROUPS: NavGroup[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { href: "/people/contracts", labelKey: "nav.contracts", icon: Files, roles: ["ceo", "hr_admin", "dept_head"] },
      { href: "/people/onboarding", labelKey: "nav.onboarding", icon: ClipboardList, roles: ["ceo", "hr_admin", "dept_head"] },
